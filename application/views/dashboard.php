<div class="container">
  ...
  <div class="col-sm-12" style="padding: 10px; background-color: white; border: 1px solid #ddd;"><i
      class="fa fa-dashboard" style="font-size:28px"> Dashboard</i> <a
      href="<?php echo base_url('dashboard/updateprofile') ?>" class="btn btn-default pull-right">Update Profile</a>
  </div>
  <hr> <br><br>
...
?>
 ...
 ?>
    ...
    <a href="<?php echo base_url("messagescontroller") ?>"><button type="button" class="btn btn-default">Messages <span
          class="badge"><?php echo 'inbox messages here' ?></span></button></a>


    <?php  ?>
    <a href="<?php echo base_url('controller/method') ?>"><button type="button" class="btn btn-default">Saved Order
        <span class="badge"> $
    ...
    <div class="row" style=" padding: 2px; border-bottom: 4px solid #841990;">
      <div class="col-md-3 col-sm-4 text-center" id="uploadDiv"><br>
        <div>
          <a class="btn btn-primary" style="color: #fff" id="button"
            href="<?php echo base_url('controllertouploadimage') ?>"><i class="fa fa-pencil"> Upload a New Image</i>
          </a>
        </div><br>
        <img src="<?php echo base_url('imagesfolder') ?>/<?php echo 'image name here'; ?> "
          class="img-rounded pull-left img-responsive" alt="Upload a Profile Image" width="100%" height="180"
          style="border: 1px solid #841990;">
      </div><br>
      ...
      <div class="col-md-3 col-sm-12" style="border-left: 1px solid #ddd;">
        ...
        <h5 style="color: #841990" id="ViewProfileDiv"><a href="<?php echo base_url("agentscontroller") ?>"
            style="color: #841990"><i class="fa fa-group btn btn-default"></i> Find Agents</a><br>
          <a href="<?php echo base_url("controller/method") ?>/?userid=<?php echo 'session id here' ?>"
            id="button3">View Public Profile</a></h5>
        <hr>
        <?php
        ...
        <h5 data-toggle="modal" data-target="#adminmsg" style="color: #841990"><i
            class="fa fa-envelope btn btn-default"></i> Message Support</h5>
        <hr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea aria-required="true" rows="8" cols="45" name="message" id="message" class="form-control"
              placeholder="Type Message Here " required></textarea>
          </div>
          <div class="form-group">
            <label class="checkbox-inline"><span class="required"></span><input type="checkbox"
                value="<?php echo 'fileattached name here'; ?>" name="attachment">Attach Certification</label>
          </div>
          <div class="form-group">
                ...
                <table class="table table-bordered table-hover" style="background-color: #fff">
                  ...
                  <tr>
                    ...
                    <td class="text-center"><br>
                      <h5 data-toggle="modal" data-target="#adminmsg" data-dismiss="modal" style="color: #841990"><i
                          class="fa fa-envelope btn btn-default"></i> Report</h5>
                    </td>
                  </tr>
